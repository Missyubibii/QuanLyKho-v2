...
@section('content')
<div classa="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
    <div class="mb-6 ">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex items-center space-x-4">
            <div class="flex-shrink-0 w-12 h-12 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" class="w-6 h-6 text-yellow-600 dark:text-yellow-300" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M2 15h10"></path><path d="m9 18 3-3-3-3"></path></svg>
            </div>
            <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex items-center space-x-4">
            <div class="flex-shrink-0 w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
                <svg class="w-6 h-6 text-green-600 dark:text-green-300" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M4 7V4a2 2 0 0 1 2-2 2 2 0 0 0-2 2"></path><path d="M4.063 20.999a2 2 0 0 0 2 1L18 22a2 2 0 0 0 2-2V7l-5-5H6"></path><path d="m5 11-3 3"></path><path d="m5 17-3-3h10"></path></svg>
            </div>
            <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <table class="min-w-full text-sm divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center font-semibold text-gray-600 dark:text-gray-300">Tồn kho</th>
                            <th class="px-4 py-2 text-center font-semibold text-gray-600 dark:text-gray-300">Tối thiểu</th>
                            <th class="px-4 py-2 text-right font-semibold text-gray-600 dark:text-gray-300">Hành động</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @php /** @var \App\Models\Product $product */ @endphp
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-4 py-3 text-center text-gray-600 dark:text-gray-300">{{ $product->min_stock }}</td>
                                <td class="px-4 py-3 text-right">
                                    <a href="{{ route('admin.products.show', $product) }}" class="font-medium text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">Xem</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
        ...
        <div class="lg:col-span-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Hoạt động gần đây</h3>
            </div>
                ...
                @forelse ($recentMovements ?? [] as $movement)
                    <div class="flex space-x-3">
                        <div class="flex-shrink-0">
                            @if($movement->type == 'in')
                                <span class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center">
                                    <svg class="w-5 h-5 text-green-600 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                                </span>
                            @else
                                <span class="w-8 h-8 rounded-full bg-red-100 dark:bg-red-900 flex items-center justify-center">
                                    <svg class="w-5 h-5 text-red-600 dark:text-red-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6"></path></svg>
                                </span>
                            @endif
                        </div>
                        <div class="flex-1">
                            <p class="text-sm text-gray-800 dark:text-gray-200">
                                ...
                                @endif
                                {{ $movement->quantity }} ({{ $movement->product->name ?? 'N/A' }})
                            </p>
...
@push('scripts')
{{-- Bạn có thể thêm JS cho biểu đồ ở đây nếu cần --}}
