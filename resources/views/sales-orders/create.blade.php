...
@section('content')
    <div class="p-6 max-w-6xl mx-auto" x-data="salesOrderForm({ customers: @js($customers), products: [] })">
        <form method="POST" action="{{ route('admin.sales-orders.store') }}" @submit.prevent="submitForm">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Tạo Phiếu Xuất Kho Mới</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label for="customer_id"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Khách hàng <span
                                    class="text-red-500">*</span></label>
                            <select id="customer_id" name="customer_id" required x-model="selectedCustomerId"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('customer_id') @enderror">
                        ...
                        <div>
                            <label for="expected_date"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ngày dự kiến giao</label>
                                ...
                                <ul>
                                    <template x-for="product in searchResults" :key="product.id">
                                        <li @click="addProduct(product)"
                                            ...
                                            bán: <span x-text="formatCurrency(product.price_sell)"></span>/<span
                                    ...
                                    <template x-if="items.length === 0">
                                        <tr>
                                            <td colspan="5" class="text-center py-4 text-gray-500 dark:text-gray-400">Chưa
                                                có sản phẩm nào được thêm. Tìm kiếm và chọn sản phẩm ở trên.</td>
                                        </tr>
                                    </template>
                                </tbody>
                                <tfoot>
                ...
                <div
                    ...
                    <button type="submit" :disabled="isSubmitting"
                        ...
                        <span x-show="!isSubmitting">Lưu Phiếu Xuất</span>
...
@push('scripts')
    {{-- Không cần thêm gì ở đây vì đã import trong app.js --}}
@endpush
